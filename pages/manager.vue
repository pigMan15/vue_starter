   ...
   <div class="left-list"> 
    <div class="myhome-list"> 
     ...
     <ul class="home-list bottom"> 
      <router-link to='/manager/dynamic' active-class="active" tag="li" ><a>我的分享</a></router-link>   
      <router-link to='/manager/myfocus' active-class="active" tag="li" ><a>个人动态</a></router-link>   
      <router-link to='/manager/mycollect' active-class="active" tag="li" ><a>我的收藏</a></router-link>   
      <router-link to='/manager/myreaded' active-class="active" tag="li" ><a>浏览记录</a></router-link>   
      <router-link to='/manager/account' active-class="active" tag="li" ><a>账户设置</a></router-link>     
